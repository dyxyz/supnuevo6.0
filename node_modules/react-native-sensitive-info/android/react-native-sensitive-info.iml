...
<module external.linked.project.id=":react-native-sensitive-info" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" version="4">
